...
class DashboardCache:
    ...
    def get_container_states(self) -> Optional[Dict[str, Any]]:
    ...
    def get_incident_summaries(self) -> Optional[Dict[str, Any]]:
    ...
    def get_notification_stats(self) -> Optional[Dict[str, Any]]:
