...
class PluginRegistry:
    ...
    def scan_and_load(self, directory: Optional[str] = None) -> int:
        loaded = 0
    ...
    def _load_plugin_from_module(self, filepath: str) -> Optional[Plugin]:
        ...
        for _, obj in inspect.getmembers(module, inspect.isclass):
            if issubclass(obj, (ToolPlugin, IntegrationPlugin, SkillPlugin)) and obj is not ToolPlugin and obj is not IntegrationPlugin and obj is not SkillPlugin:
    ...
    def _try_extract_manifest(self, cls: type) -> Optional[PluginManifest]:
        defaults = {
